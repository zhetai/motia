// packages/wistro/src/core/adapters/KafkaMessageBusAdapter.js
...
export class KafkaMessageBusAdapter extends MessageBusAdapter {
  constructor(config = {}) {
    ...
    this.config = {
      ...
      clientId: config.clientId || "wistro",
      topicPrefix: config.topicPrefix || "wistro.events.",
      groupId: config.groupId || "wistro-group",
      ...config,
    };
    this.kafka = null;
    this.producer = null;

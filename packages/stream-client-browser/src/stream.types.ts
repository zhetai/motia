...
export type ItemJoinMessage = { streamName: string; groupId: string; id: string; subscriptionId: string }
export type GroupJoinMessage = { streamName: string; groupId: string; subscriptionId: string }

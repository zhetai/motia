...
✨ Zero configuration with in-memory storage out of the box <br />
🔌 Flexible storage options including Memory, File, and Redis adapters <br />
🧹 Automatic state cleanup with TTL support <br />
🔒 Built-in isolation to keep your flow states separate and secure <br />
